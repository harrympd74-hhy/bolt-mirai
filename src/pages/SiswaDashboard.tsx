...
function StudentHome({ onClass }: { onClass: (topic: "Bangun Ruang Segitiga" | "Jenis-Jenis Garis") => void }) {
  return (
...
export default function SiswaDashboard() {
  ...
  const [classTopic, setClassTopic] = useState<"Bangun Ruang Segitiga" | "Jenis-Jenis Garis">("Bangun Ruang Segitiga");
