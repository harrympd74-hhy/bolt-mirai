...
const quickActions = [
  { id: "tugas", label: "Buat Tugas", caption: "Buat tugas baru", icon: ClipboardList, tone: "turquoise" },
  { id: "presensi", label: "Input Nilai", caption: "Kelola penilaian", icon: TrendingUp, tone: "sapphire" },
  { id: "modul-ajar", label: "Unduh RPP", caption: "Siapkan pembelajaran", icon: BookOpen, tone: "yellow" },
  { id: "sumber-materi", label: "Jelajahi Materi", caption: "Dari pustaka kelas", icon: WalletCards, tone: "brown" },
] as const;
